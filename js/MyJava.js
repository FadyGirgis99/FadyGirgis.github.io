...
$(document).ready(function () {
  ...
  ;
    ...
    $("#flip").click(function () {
        $("#flip").css("background-color", "#f5f6f9").css("color", "#3071a9").css("border", "solid 1px #e1e1e2");
    });
    ...
    $("#flip2").click(function () {
        $("#flip2").css("background-color", "#f5f6f9").css("color", "#3071a9").css("border", "solid 1px #e1e1e2");
    });
...
$("textarea[name='textareaa']").keyup(function () {
    if ($(this).val().length <= 199) {
        $("#Char").text(200 - $(this).val().length + " Characters "); } else {
